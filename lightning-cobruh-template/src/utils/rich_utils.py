...
def print_config_tree(
    ...
    :param cfg: A DictConfig composed by Cobruh.
    ...
    :param save_to_file: Whether to export config to the output folder.
    """
    style = "dim"
...
def enforce_tags(cfg: DictConfig, save_to_file: bool = False) -> None:
    ...
    :param cfg: A DictConfig composed by Cobruh.
    :param save_to_file: Whether to export tags to the output folder.
    """
    if not cfg.get("tags"):
